...
class PopularGridCellThree: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    

    var banner = Banner?.self
    
    fileprivate let data = [
        CustomData(title: "Banner !!!", backgroundImage: #imageLiteral(resourceName: "grid1")),
    ]
    ...
    func setupViews(){
        ...
        mainCollectionView.register(PopularCellThree.self, forCellWithReuseIdentifier: "cellId")
...
class PopularCellThree: UICollectionViewCell {
    ...
    let bannerImage: UIImageView = {
        ...
        imageView.image = UIImage(named: "grid3")
