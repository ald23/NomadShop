...
class PopularGridCellTwo: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func setupViews(){
        ...
        mainCollectionView.register(PopularCellTwo.self, forCellWithReuseIdentifier: "cellId")
...
class PopularCellTwo: UICollectionViewCell {
...
//
//        guard let nv = self.viewControllers?.first else { return print("Failed to get current view controller") }
//
//        guard let CategoriesTableViewController = self.dataSource?.pageViewController( self, viewControllerAfter: nv) else { return }
//
//        setViewControllers([CategoriesTableViewController], direction: .forward, animated: false, completion: nil)
//    }
//
//
...
//        self.navigationController?.pushViewController(vc,animated:true)
    ...
    func setupViews(){
        ...
        bannerImage.snp.makeConstraints {(make) in
            ...
            make.centerY.equalTo(view.snp.bottom).offset(-120)
    ...
    let bannerImage: UIImageView = {
        ...
        imageView.image = UIImage(named: "grid2")
