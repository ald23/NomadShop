...
class CategoriesVC_5: UIViewController {
...
extension CategoriesVC_5: UITableViewDelegate, UITableViewDataSource {
...
extension CategoriesVC_5 {
    func fetchData() -> [Category] {
        let category1 = (Category(title: "Все товары", image: UIImage.init(named: "Arrow-1")!))
        let category2 = (Category(title: "Дифференциал", image: UIImage(named: "Arrow-1")!))
        let category3 = (Category(title: "Раздаточная коробка", image: UIImage(named: "Arrow-1")!))
        let category4 = (Category(title: "Механизм газораспределения", image: UIImage(named: "Arrow-1")!))
