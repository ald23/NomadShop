...
class KlapanCells_2: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func setupViews(){
        ...
        mainCollectionView.register(KlapanCellSubclass_2.self, forCellWithReuseIdentifier: "cellId")
