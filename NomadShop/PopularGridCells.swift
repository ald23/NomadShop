...
class PopularGridCells: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func setupViews(){
        ...
        mainCollectionView.register(PopularCell.self, forCellWithReuseIdentifier: "cellId")
...
class PopularCell: UICollectionViewCell {
    ...
    required init?(coder: NSCoder) {
     ...
     func setupTitleForPopularGrid() {
        let text_1 = UILabel()
        text_1.text = "Популярные"
        text_1.font = UIFont(name: "SanFranciscoDisplay-Black", size: 13)
        text_1.font = text_1.font.withSize(20)
        text_1.textColor = .black
    ...
    let bannerImage: UIImageView = {
        ...
        imageView.image = UIImage(named: "grid1")
